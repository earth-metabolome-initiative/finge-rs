...
pub use crate::{
    ...
    mutations::{
        ...
        MutatorError, PredicateClass, TopologicalPathologyMutator, TopologicalPathologyPredicate,
...
pub mod prelude {
    ...
    pub use crate::{
        ...
        TopologicalTorsionGraph, ViolationClass, ViolationLabel, ViolationPredicate,
